...
class SwipeCardState extends State<SwipeCard> {
  ...
  void _onPanEnd(DragEndDetails details) {
    ...
    double potentialX = _positionX + (details.velocity.pixelsPerSecond.dx * widget.threshold);
    double potentialY = _positionY + (details.velocity.pixelsPerSecond.dy * widget.threshold);
  ...
  void _animate(double angle) {
    ...
    Velocity velocity = Velocity(
      pixelsPerSecond: Offset(
        remainingX / widget.threshold, 
        remainingY / widget.threshold
      )
    );
